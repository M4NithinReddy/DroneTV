  ...
  return (
    <section ref={galleryRef} className="py-20 px-4 bg-black text-white">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-center mb-12 text-[#FFE135]">Drone Expo Gallery</h2>
